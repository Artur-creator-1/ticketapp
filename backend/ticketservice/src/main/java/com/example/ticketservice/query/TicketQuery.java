package com.example.ticketservice.query;
...
public class TicketQuery {
    ...
    public static final String SELECT_TICKET_TASKS_QUERY = """
        ...
        JOIN task_statuses ts ON t.task_id = ts.task_id
    ...
    public static final String UPDATE_TASK_FUNCTION = "SELECT * FROM update_task(:userUuid, :taskUuid, :name, :description, :status)";

    public static final String DELETE_TASK_QUERY = "DELETE FROM tasks WHERE task_uuid = :taskUuid AND user_uuid = :userUuid";
